...
2. Copy ssh-pub key from **app server 3** to **backup server**. Follow [day 07](./007.md) to complete these two steps
3. Write the following script in **app server 3** `/scripts/beta_backup.sh`:
...
4. Give the execute permission for the script above:
